        ...
        return {
            ...
            claimsDelegatedOthers: new Amount(votingPowers.claimsVotes.delegatedVotingPower -
                (votingPowers.claimsVotes.delegates === params.user
                    ...
                    : 0n), 18),
            claimsDelegatedSelf: new Amount(votingPowers.claimsVotes.delegates === params.user
                ? votingPowers.claimsVotes.votingPower
                : 0n, 18),
            ...
            tokenDelegatedOthers: new Amount(votingPowers.tokenVotes.delegatedVotingPower -
                (votingPowers.tokenVotes.delegates === params.user
                    ...
                    : 0n), 18),
            tokenDelegatedSelf: new Amount(votingPowers.tokenVotes.delegates === params.user
                ? votingPowers.tokenVotes.votingPower
                : 0n, 18),
            ...
            totalDelegatedOthers: new Amount(votingPowers.claimsVotes.delegatedVotingPower -
                ...
                (votingPowers.tokenVotes.delegatedVotingPower -
                    (votingPowers.tokenVotes.delegates === params.user
                        ? votingPowers.tokenVotes.votingPower
                        : 0n)), 18),
            totalDelegatedSelf: new Amount((votingPowers.claimsVotes.delegates === params.user
                ? votingPowers.claimsVotes.votingPower
                : 0n) +
                (votingPowers.tokenVotes.delegates === params.user
                    ? votingPowers.tokenVotes.votingPower
