...
import { optimismChain } from "./chain.js";
import { optimismMarketsList } from "./core-markets.js";
import { optimismTokenList } from "./tokens.js";

const optimism = createEnvironment<typeof optimismTokenList, typeof optimismMarketsList>({
  name: "Optimism",
  chain: optimismChain,
  apis: {
...
export { optimism, optimismChain, optimismMarketsList, optimismTokenList };
