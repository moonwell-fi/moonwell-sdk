...
import { baseChain } from "./chain.js";
...
const base = createEnvironment<typeof baseTokenList, typeof baseMarketsList, typeof baseVaultList>({
  name: "Base",
  chain: baseChain,
  apis: {
...
export { baseChain, baseMarketsList, baseMorphoMarketsList, baseTokenList, baseVaultList, base };
