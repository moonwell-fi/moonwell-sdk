  ...
  <div className="pt-[48px] max-sm:pt-0">
    <div className="max-sm:px-0 flex justify-between z-0 max-md:justify-center">
      <div className="space-y-8 max-w-[400px] flex flex-col items-start max-md:items-center">
        <img className="max-h-[72px] invert-[1] dark:invert-0 max-sm:max-h-[72px]" src="/Moonwell-Logo-White.svg" alt="moonwell logo" />
        <div className="font-regular text-[21px] max-sm:text-[18px] text-[#919193] max-md:text-center">Build reliable apps & libraries with <span className="text-black dark:text-white">lightweight</span>, <span className="text-black dark:text-white">composable</span>, and <span className="text-black dark:text-white">type-safe</span> modules that interface with Moonwell</div>
