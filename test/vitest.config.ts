...
export default defineConfig({
  ...
  test: {
    ...
    include: [
      ...
      "src/actions/retry.test.ts",
      "src/actions/axiosWithRetry.test.ts",
      "src/actions/core/markets/getMarkets.unit.test.ts",
      ...
      "src/actions/core/getUserBalances.unit.test.ts",
      "src/actions/core/user-positions/getUserPositions.failures.test.ts",
      "src/client/createMoonwellClient.test.ts",
      "src/common/getBlockNumberAtTimestamp.test.ts",
      "src/common/readAcrossEnvironments.test.ts",
